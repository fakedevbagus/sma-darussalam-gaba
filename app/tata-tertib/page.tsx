  ...
  return (
    <div>
      ...
      <section className="max-w-[1280px] mx-auto px-6 space-y-6">
        <div className="bg-white rounded-[32px] p-8 shadow-card border border-[#ece4d4] flex gap-4 items-center">
        ...
        <div className="space-y-4">
          {TATA_TERTIB.categories.map((cat, idx) => {
            ...
            return (
              <div key={idx} className="bg-white rounded-[24px] shadow-card border border-[#ece4d4] overflow-hidden">

    ...
    <div>
      ...
      <section className="max-w-[1280px] mx-auto px-6">
        ...
        <div className="mt-8 grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
          {list.map(a=> (
            <Link key={a.id} href={`/pengumuman/${a.slug}`} className="bg-white rounded-[28px] p-6 shadow-card border border-[#ece4d4] hover:shadow-3d hover:-translate-y-0.5 transition group">

  ...
  return (
    <div>
      ...
      <section className="max-w-[1280px] mx-auto px-6 -mt-2">
        ...
        {filter==="all" && pinned && !q && (
          <Link href={`/berita/${pinned.slug}`} className="mt-8 block bg-gradient-to-br from-primary-600 to-primary-800 text-white rounded-[24px] p-6 md:p-8 shadow-3d hover:shadow-glow transition">
        ...
        <div className="mt-10 bg-slate-50 border border-slate-200 rounded-[24px] p-6 text-center">

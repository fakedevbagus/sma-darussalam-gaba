...
const STATS = [
  ...
  { value: "85%", label: "Lanjut PT" },
  { value: "120+", label: "Berprestasi" },
  { value: "30+", label: "Tahun Lulusan" },
];
    ...
    <div>
      ...
      <section className="max-w-[1280px] mx-auto px-6 -mt-2">
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
          {STATS.map(s=> (
            <div key={s.label} className="bg-white rounded-2xl p-5 text-center shadow-card border border-slate-100">
        ...
        <div className="mt-8 grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {ALUMNI.map(a=> (
            <div key={a.id} className="bg-white rounded-[24px] overflow-hidden shadow-card border border-slate-100 hover:shadow-3d transition">
